...
def kp_connections(keypoints):
    kp_lines = [
        [keypoints.index('neck'), keypoints.index('right_hip')], #0
        [keypoints.index('right_hip'), keypoints.index('right_knee')], #1
        [keypoints.index('right_knee'), keypoints.index('right_ankle')], #2
        [keypoints.index('neck'), keypoints.index('left_hip')], #3
        [keypoints.index('left_hip'), keypoints.index('left_knee')], #4
        [keypoints.index('left_knee'), keypoints.index('left_ankle')], #5
        [keypoints.index('neck'), keypoints.index('right_shoulder')], #6
        [keypoints.index('right_shoulder'), keypoints.index('right_elbow')], #7
        [keypoints.index('right_elbow'), keypoints.index('right_wrist')], #8
        [keypoints.index('right_shoulder'), keypoints.index('right_eye')], #9
        [keypoints.index('neck'), keypoints.index('left_shoulder')], #10
        [keypoints.index('left_shoulder'), keypoints.index('left_elbow')], #11
        [keypoints.index('left_elbow'), keypoints.index('left_wrist')], #12
        [keypoints.index('left_shoulder'), keypoints.index('left_eye')], #13
        [keypoints.index('neck'), keypoints.index('nose')], #14
        [keypoints.index('nose'), keypoints.index('right_eye')], #15
        [keypoints.index('nose'), keypoints.index('left_eye')], #16
        [keypoints.index('right_eye'), keypoints.index('right_ear')], #17
        [keypoints.index('left_eye'), keypoints.index('left_ear')] #18
    ]
    return kp_lines
...
class CocoKeypoints(torch.utils.data.Dataset):
    ...
    def single_image_processing(self, image, anns, meta, meta_init):
        ...
        # flow_color = flow_to_color(pafs[:, :, 0:2], convert_to_bgr=False)
