...
class HourglassNet(nn.Module):
    ...
    def __init__(self, num_stacks=cfg.num_stacks, num_blocks=cfg.num_blocks, num_joints=18):
        ...
        self.conv1 = nn.Conv2d(22, self.inplanes, kernel_size=3, stride=2, padding=1, bias=True)
        ...
        for i in range(num_stacks):
            ...
            score.append(nn.Conv2d(ch, 3, kernel_size=1, bias=True))
            if i < num_stacks - 1:
                fc_.append(nn.Conv2d(ch, ch, kernel_size=1, bias=True))
                score_.append(nn.Conv2d(3, ch, kernel_size=1, bias=True))
...
class hg_net(nn.Module):
    def __init__(self):
        ...
        self.main_net = HourglassNet()
        self.deconv_net = HeadNet()

    def forward(self, input):
        intermediate, out = self.main_net(input)
